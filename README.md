<h1>The Website server's side is built using Node JS, APIs written using Express JS and the Database used is MongoDB. The Front end part of the website is built using HTML,CSS 
  and Vanilla JS</h1>
